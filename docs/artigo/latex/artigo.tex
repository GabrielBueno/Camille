...
dos dados, sendo esta estaticamente definida de acordo com o problema que está sendo atacado e a sua natureza.
...
mas também o da própria \emph{representação}. Criar uma representação de dados que torna fácil a extração de padrões de fala em uma amostra
de áudio digital, ou a deteção de uma face em termos dos pixels em uma imagem é,
por exemplo, uma tarefa nada trivial. Tendo em vista estas situações, algoritmos capazes de abstrair a devida representação que se
deve utilizar em cada caso foram e estão sendo desenvolvidos e estudados. O \emph{Deep Learning} é um dos exemplos deste tipo de algoritmo
de aprendizado de representações.
