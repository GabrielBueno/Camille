...
% Um formulário em uma ferramenta online foi criado para entrevistar e coletar as respostas dos entrevistados. As pessoas que participaram da pesquisa foram alcançadas pela propagação deste formulário em redes sociais e nos círculos sociais dos realizadores do projeto. As perguntas realizadas são objetivas, a não ser por uma, opcional, onde o entrevistado pode escrever o que pensa sobre a ideia apresentada. As perguntas foram elaboradas de forma a traçar o interesse geral pela disciplina de educação artística e a importância que se é dado à ela por um indivíduo já na sua idade adulta. Pedimos para que o entrevistado relembre de sua época escolar e da sua então opinião sobre a disciplina; diga a importância atual que a arte tem na sua vida; e opine se a tecnologia ajudaria no ensino de arte.

% A maioria dos entrevistados cursou a disciplina de educação artística nos ensino fundamental e médio, porém nota-se que a preferência por esta matéria está bem distribuída, já que aproximadamente 50% responderam que gostavam das aulas. Nota-se que a maioria das pessoas entrevistadas utiliza as artes de alguma forma no seu dia a dia. Conhecer outras realidades e se colocar no lugar de outras pessoas, alimento para introspecção, ferramenta política de protesto, ou uma simples forma de se distrair da rotina cotidiana foram os objetivos mais citados para o uso pessoal da arte.

% Mais de 90% dos entrevistados acham que a tecnologia pode servir como ferramenta de auxílio à educação artística, fazendo com que os alunos se interessem mais pelos assuntos abordados. Houve quase um consenso sobre a importância da abordagem das artes nas escolas, já que uma pequena minoria não atribui importância alguma à essa disciplina na formação de um indivíduo. Dos entrevistados que dissertaram sua opinião sobre o projeto apresentado, a maioria se mostrou favorável e receptível à ideia. Mais de 90% dos entrevistados concordam que a tecnologia auxiliaria no ensino de artes. Um dos entrevistados, porém, apontou que o uso da tecnologia na sala de aula é irrelevante caso o professor não tenha a habilidade de usá-la de forma eficiente para tornar suas aulas interessantes.

% A maioria das respostas mostra que na amostra de pessoas entrevistadas há um sentimento positivo em relação à ideia apresentada, o que cria um cenário otimista para a implementação do projeto.

% Apesar de a maioria dos entrevistados ter cursado disciplinas de educação artística no ensino fundamental e médio, há uma notória divisão na sua apreciação. Aproximadamente metade dos entrevistados apontaram que não gostavam dessas aulas. O contraponto à essa reação negativa na entrevista pode ser observada na grande quantidade de respostas que apoiam o uso da tecnologia como atrativo nas aulas. A partir da relação entre as respostas destas duas questões podemos inferir que o projeto é sim interessante para servir como auxílio na sala de aula, para tentar manter o interesse do aluno nos assuntos abordados pelo professor.
